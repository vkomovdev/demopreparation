...
internal class UpdateDietRequestWithAuditCommandHandler : UpsertDietRequestHandler, IRequestHandler<UpdateDietRequestWithAuditRequest, UpdateDietRequestResponse>
{
	...
	public UpdateDietRequestWithAuditCommandHandler(
	...
	public async Task<UpdateDietRequestResponse> Handle(UpdateDietRequestWithAuditRequest request, CancellationToken cancellationToken)
	{
		...
		try
		{
			...
			return _mapper.Map<UpdateDietRequestResponse>(await _dietRequestUpdater.UpdateAsync(dietRequest, audit));
		}
