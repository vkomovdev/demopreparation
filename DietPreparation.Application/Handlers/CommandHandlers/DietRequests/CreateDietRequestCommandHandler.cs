...
internal class CreateDietRequestCommandHandler : UpsertDietRequestHandler, IRequestHandler<CreateDietRequestRequest, CreateDietRequestResponse>
{
	protected readonly IDietRequestCreator _dietRequestCreator;
	...
	public CreateDietRequestCommandHandler(
	...
	public async Task<CreateDietRequestResponse> Handle(CreateDietRequestRequest request, CancellationToken cancellationToken)
	{
		try
		{
			...
			return _mapper.Map<CreateDietRequestResponse>(await _dietRequestCreator.CreateAsync(dietRequest));
		}
